        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="reservation.jsp" class="sidebar-link text-muted active"><i class="o-table-content-1 mr-3 text-gray"></i><span>Reservation</span></a></li>
                </ul>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="start_date" type="date"	placeholder="start date" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">End Date</label>
                                                    <div class="col-sm-9">
                                                        <input id="end_date" type="date"	placeholder="end date" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
