...
<html>
    ...
    <body onload="load()">
        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="housekeeping.jsp" class="sidebar-link text-muted active"><i class="o-clock-1 mr-3 text-gray"></i><span>HouseKeeping</span></a></li>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header d-flex align-items-center">
                                            <h3 class="h4">Housekeeping</h3>
                                        </div>
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="housekeeping_id" type="hidden"	value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="task" type="text"	placeholder="task" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
        ...
        <script src="ajax/HousekeepingJS.js" type="text/javascript"></script>
