...
<html>
    ...
    <body onload="load()">
        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="room.jsp" class="sidebar-link text-muted active"><i class="o-home-1 mr-3 text-gray"></i><span>Room</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="room_id" type="hidden"	value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="qty" type="text" onkeypress="onClickValidationContactNumber()"	placeholder="qty" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
        ...
        <script src="ajax/RoomJS.js" type="text/javascript"></script>
