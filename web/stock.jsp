        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="stock.jsp" class="sidebar-link text-muted active"><i class="o-database-1 mr-3 text-gray"></i><span>Stock</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="qty" type="number" onkeypress="validateNumber()"	placeholder="qty" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
