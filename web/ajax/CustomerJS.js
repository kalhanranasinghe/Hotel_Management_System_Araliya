...
function selectedRowToInput() {
    ...
    for (var i = 1; i < table.rows.length; i++) {
        table.rows[i].onclick = function () {
            ...
            document.getElementById("address").value = this.cells[5].textContent;
            document.getElementById("loyalty").value = this.cells[6].textContent;
...
function save() {
    ...
    var action = "insert";
    if (customer_id === "" || name === "" || contact_no === "" || email === "" || address === "" || loyalty === "" || date_time === "") {
        ...
        $.ajax({
            url: 'CustomerServlet',
            method: 'POST',
            data: {action: action, customer_id: customer_id, name: name, contact_no: contact_no, email: email, address: address, loyalty: loyalty, date_time: date_time},
...
function update() {
    ...
    } else if (customer_id === "" || name === "" || contact_no === "" || email === "" || address === "" || loyalty === "" || date_time === "") {
        alert("Please Enter All Details")
    } else if (contactValidation() || ValidateEmail()) {
