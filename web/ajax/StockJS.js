...
function save() {
    ...
    var action = "insert";
    if (stock_id === "" || category === "" || name === "" || price === "" || qty === "" || status === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'StockServlet',
            method: 'POST',
            data: {action: action, stock_id: stock_id, category: category, name: name, price: price, qty: qty, status: status, date_time: date_time},
...
function update() {
    ...
    } else if (stock_id === "" || category === "" || name === "" || price === "" || qty === "" || status === "" || date_time === "") {
        alert("Please Enter All Details")
    } else {
        $.ajax({
            url: 'StockServlet',
