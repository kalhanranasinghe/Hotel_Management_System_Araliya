        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="grn.jsp" class="sidebar-link text-muted active"><i class="o-document-1 mr-3 text-gray"></i><span>GRN</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="ststus" type="text"	placeholder="ststus" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
