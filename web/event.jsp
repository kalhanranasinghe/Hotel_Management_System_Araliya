...
<html>
    ...
    <body onload="load()">
        ...
        <div class="d-flex align-items-stretch">
            <div id="sidebar" class="sidebar py-3">
                ...
                <ul class="sidebar-menu list-unstyled">
                    ...
                    <li class="sidebar-list-item"><a href="event.jsp" class="sidebar-link text-muted active"><i class="o-survey-1 mr-3 text-gray"></i><span>Event</span></a></li>
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal">
                                                <div class="form-group row">
                                                    <div class="col-sm-9">
                                                        <input id="event_id" type="hidden"	value="0" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input id="time" type="time"	placeholder="time" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-3 form-control-label">No of Members</label>
                                                    <div class="col-sm-9">
                                                        <input id="no_of_members" onkeypress="onClickValidationContactNumber()" type="text"	placeholder="no of members" class="form-control form-control-warning">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
        ...
        <script src="ajax/EventJS.js" type="text/javascript"></script>
